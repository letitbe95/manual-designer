# 📖 Manual Designer | Corporate Brochure & Product Manual Creator
...
- **Standardized Facing Pages Layout**: Fixed canvas size of **42.61 × 29.11 cm** (Width × Height), optimized for high-end print design (you can modify the prompt if other sizes are needed).
